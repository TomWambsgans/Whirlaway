...
pub fn run_whir_verif() {
    ...
    fn dot_product_base_extension(a, b, res) {
        ...
        // The following is equivalent to, but the compiler needs to be improved.
        // res_ptr = res * 8;
        // for i in 0..8 unroll {
        //     my_buff = malloc(128);
        //     my_buff[0] = prods[i];
        //     for j in 0..127 unroll {
        //         my_buff[j + 1] = my_buff[j] + prods[i + (j * 8)];
        //     }
        //     res_ptr[i] = my_buff[127];
        // }
        res_ptr = res * 8;
